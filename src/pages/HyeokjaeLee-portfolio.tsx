        ...
        <section>
          ...
          <ul className="contact-channel-list">
            ...
            <li>
              <Chrome />
              <b>Blog.</b>
              <Link to="/">https://hyeokjaelee.github.io</Link>
            </li>
            <li>
              <Naver />
              <b>Blog(2011~2015).</b>
            ...
            <div>
              <div className="description">
                ...
                <p className="project-link">
                  <Chrome />
                  <span>Blog Post</span>
                  <Link to="/gititle-project">https://hyeokjaelee.github.io/gititle-project</Link>
                </p>
              </div>
              <ul className="content-list">
                <li>
                  커밋 규칙 정리
                  <Link to="/good-commit-message">
            ...
            <div>
              <div className="description">
                ...
                <p className="project-link">
                  <Chrome />
                  <span>Blog Post</span>
                  <Link to="/korea-webtoon-api-update">
