...
const About = () => {
  ...
  return (
    <article className={theme === "dark" ? style.aboutDark : style.about}>
      <section>
        <h2>💡 About Me</h2>
        <div className={`${style.aboutMeContent} ${style.sectionContentWrap}`}>
      ...
      <section>
        ...
        <ul className={`${style.contactChannelList} ${style.sectionContentWrap}`}>
          <li>
            <Gmail />
            <b>Email.</b>
      ...
      <section>
        ...
        <div className={`${style.workWrap} ${style.sectionContentWrap}`}>
          <h3>Coupang Eats</h3>
      ...
      <section>
        ...
        <ul className={`${style.toolList} ${style.sectionContentWrap}`}>
          <li>
            <Javascript />
            Javascript
          </li>
      ...
      <section>
        <h2>🔖 Projects</h2>
        <div className={`${style.sectionDescription} ${style.sectionContentWrap}`}>
          <div className={style.sectionTitle}>
            <h3>Gititle</h3>
          ...
          <div>
            <div>
              ...
              <p className={style.projectLinkWrap}>
                <Github />
