...
export const WorkExperienceSection = () => (
  <section>
    <h2 className="mb-6 text-3xl font-bold" id={ABOUT_TITLE_ID.WORK_EXPERIENCE}>
      👨‍💻 Work experience
    </h2>
    <Experience
      borderBottom
      ...
      <li>
        ...
        <Accordion className="mb-2 w-full">
          ...
          <Accordion.Contents className="text-sm">
            <dl>
              <dt className="mb-1 text-base text-zinc-400">강점</dt>
              ...
              <dt className="mb-1 mt-4 text-base text-zinc-400">
                개선해야할 점
              </dt>
              <dd className="whitespace-pre-wrap">
