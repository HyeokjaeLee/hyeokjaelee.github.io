  ...
  >
    <ul>
      <AboutItem
        ...
        summaries={[
          '채용 플랫폼 디자인시스템 개발',
          '외부 렌더링을 발생 시키지 않는 유효성 검사 라이브러리 개발',
        ...
        experiences={[
          '채용 플랫폼 개발팀에 첫번째 프론트엔드 개발자로 합류해 비즈니스 설계, 기획, 개발자 채용등 전반적인 업무에 참여했어요.',
      ...
      <AboutItem
        ...
        experiences={[
          '기존 환경에서 불필요하거나 중단된 도구를 적극적으로 찾아내 제거 하고 개선 했어요.',
          'GraphQL을 장점을 이해하고 API 스키마 설계 과정에 참여해 개발단계에서의 소통비용을 줄였어요.',
          '팀내 여러 직군들과 효율적으로 소통하는 방법을 고민하고 실천했어요.',
