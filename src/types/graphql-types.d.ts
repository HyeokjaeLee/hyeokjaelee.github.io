...
export type PostSearchboxStaticQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type PostSearchboxStaticQueryQuery = { allMarkdownRemark: { nodes: Array<{ fields?: { slug?: string | null } | null, frontmatter?: { title?: string | null, emoji?: string | null } | null }> } };
