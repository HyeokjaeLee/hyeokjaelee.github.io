...
const STARS = [
  { top: '20%', left: '14%', size: 2, delay: '0s' },
  { top: '60%', left: '8%', size: 1, delay: '0.6s' },
  { top: '30%', left: '42%', size: 1, delay: '1.1s' },
  { top: '70%', left: '36%', size: 2, delay: '0.3s' },
  { top: '14%', left: '30%', size: 1, delay: '1.6s' },
  { top: '50%', left: '22%', size: 1, delay: '0.9s' },
];
      ...
      <span className="dms__knob" aria-hidden="true">
        ...
        <span className="dms__moon">
          <span
            ...
            style={{ top: '24%', left: '28%', width: 4, height: 4 }}
          />
          <span
            className="dms__crater"
            style={{ top: '52%', left: '58%', width: 3, height: 3 }}
          />
          <span
            className="dms__crater"
            style={{ top: '40%', left: '18%', width: 3, height: 3 }}
          />
        </span>
      </span>
    </button>
