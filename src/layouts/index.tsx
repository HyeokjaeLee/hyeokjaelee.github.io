...
const Layout = (props: LayoutProps) => {
  ...
  const [
    darkMode,
    setDarkMode,
    { backgroundColor1, textColor1, borderColor1 },
  ...
  return (
    <div
      ...
      className={`flex flex-col min-h-[100vh] items-center ${backgroundColor1} ${textColor1} animate-fade-in`}
    >
      <header
        className={
      ...
      <footer
        className={`${DEFAULT_WIDTH} py-10 border-t-[1px] ${borderColor1} ${
