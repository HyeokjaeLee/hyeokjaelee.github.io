...
// EXTERNAL MODULE: ./node_modules/@deckdeckgo/highlight-code/dist/esm/index-54334b7b.js
var index_54334b7b = __webpack_require__(1618);
;// CONCATENATED MODULE: ./node_modules/@deckdeckgo/highlight-code/dist/esm/deckdeckgo-highlight-code-languages-ce6124c0.js
...
;// CONCATENATED MODULE: ./node_modules/@deckdeckgo/highlight-code/dist/esm/deckgo-highlight-code.entry.js
...
const CarbonThemeStyle = ({ style }) => {
  return ((0,index_54334b7b.h)("style", null, `
      :host ${style};
    `));
};
...
const DeckdeckgoHighlightCode = class {
  constructor(hostRef) {
    (0,index_54334b7b.r)(this, hostRef);
    this.prismLanguageLoaded = (0,index_54334b7b.c)(this, "prismLanguageLoaded", 7);
    this.codeDidChange = (0,index_54334b7b.c)(this, "codeDidChange", 7);
    /**
  ...
  render() {
    ...
    return ((0,index_54334b7b.h)(index_54334b7b.H, { class: hostClass, onClick: () => this.edit() }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), (0,index_54334b7b.h)("div", { class: "container", ref: (el) => (this.refContainer = el) }, (0,index_54334b7b.h)("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, contentEditable: this.editable, onBlur: async () => await this.applyCode(), onInput: () => this.inputCode(), onKeyDown: ($event) => this.catchTab($event), ref: (el) => (this.refCode = el) }), (0,index_54334b7b.h)("slot", { name: "code" }))));
  }
  renderHighlightStyle() {
    if (!this.highlightLines || this.highlightLines.length <= 0) {
      return undefined;
    }
    return (0,index_54334b7b.h)(HighlightStyle, Object.assign({}, this.highlightRows));
  }
  renderCarbon() {
    if (this.terminal !== DeckdeckgoHighlightCodeTerminal.CARBON) {
      return undefined;
    ...
    return [
      (0,index_54334b7b.h)(CarbonThemeStyle, { style: this.themeStyle }),
      (0,index_54334b7b.h)("div", { class: "carbon" }, this.renderCarbonCircle('red'), this.renderCarbonCircle('yellow'), this.renderCarbonCircle('green'))
    ];
  }
  renderCarbonCircle(color) {
    return (0,index_54334b7b.h)("div", { class: color });
  }
  renderUbuntu() {
    if (this.terminal !== DeckdeckgoHighlightCodeTerminal.UBUNTU) {
      return undefined;
    }
    return ((0,index_54334b7b.h)("div", { class: "ubuntu" }, this.renderUbuntuCircle('close'), this.renderUbuntuCircle('minimize'), this.renderUbuntuCircle('maximize'), (0,index_54334b7b.h)("p", null, (0,index_54334b7b.h)("slot", { name: "user" }))));
  }
  renderUbuntuCircle(mode) {
    const symbol = mode === 'close' ? '&#10005;' : mode === 'minimize' ? '&#9472;' : '&#9723;';
    return ((0,index_54334b7b.h)("div", { class: mode }, (0,index_54334b7b.h)("span", { innerHTML: symbol })));
  }
  get el() { return (0,index_54334b7b.g)(this); }
