...
이날 나는 "순서를 설정이 아니라 코드에 명시해야 한다"는 교훈을 정리한 날이다.
...
근데 템플릿 자체가 원인이면, 모델이 위키를 읽고 고쳐도 다음

세션에서 템플릿이 다시 잘못된 지시를 준다.
...
분할"이 아니라, "분할하면 맥락이 단절되는가"를 먼저 물어야 한다.
