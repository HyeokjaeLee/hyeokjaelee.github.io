...
description: '확장 두 개가 쓸모없어져서 폐기했다
...
이날 나는 "쓸모없어진 코드를 어떻게 검증하고 폐기하는가"를 정리한 날이다.
...
야후 파이낸스의 야후 파이낸스의 범위 시작점 종가 필드를 "전 거래일 종가"로 읽었다.
