...
description: '옵시디언 볼트 실제 콘텐츠는 11MB인데 CouchDB가 2.76GB까지 부풀었다
...
원격이 변하지 않은 상태에서 클라이언트만 재구축하면, 원본이 그대로니까
