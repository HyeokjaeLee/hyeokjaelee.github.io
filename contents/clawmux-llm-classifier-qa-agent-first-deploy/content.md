...
가벼운 LLM이 내놓는 한 글자가 키워드 규칙이랑 로컬 임베딩 둘 다 이겼다.
...
병렬로 실행하다 보니 큐 처리에서 경쟁 상태가 생겼던 거다.
...
그런데 크래시 방어랑 큐 버그 수정을 거치니까 통과율이 확 올랐다.
