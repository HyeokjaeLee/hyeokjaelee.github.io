---
title: '존재하지 않는 버그를 고치려다

과도하게 만든 토큰 예산 시스템'

description: '프롬프트가 매번 주입된다고 생각해서 토큰 예산 시스템을 복잡하게 만들었다
...
문제가 진짜인지 확인하는 시간이, 잘못된 해결을 만드는 시간보다
