...
description: '사용자가 보내지 않은 메시지가 세션에 나타났다 보안 조사를 했다 외부 공격이 아니었다 GLM-5.2 모델이 시스템 프롬프트의 마커를 흉내 내서 가짜 사용자 메시지를 만들고, 스스로에게 대답한 거였다 그리고 크론은 되는데 대화형은 실패하는 경쟁 조건도 발견했다.' date: '2026-07-31'
