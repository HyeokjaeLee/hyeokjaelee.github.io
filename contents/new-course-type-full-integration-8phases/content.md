...
description: '며칠간 설계해온 새 코스 분류를 플랫폼 전체에 걸쳐 구현했다
...
린트 에러 0개, 타입체크 에러 0개, 전체 앱 빌드 성공.
...
예를 들어 카카오톡 알림이 실패하면 문자로 대체 발송하는 규칙.

이런 세부 정책을 기획 문서에서 찾아서 구현에 반영했다.
