...
고거래량(평균의 1.3배 이상), 보통, 저거래량(0.8배 이하).
...
사들이든, 숏 커버링이든, 가치 투자자든.

근데 저거래량 폭락은 "매수 실종"이다.
...
"하루에 0.2~0.3%씩 올라가니까, 갭을 메우는 데 몇 달 걸린다."
...
추세 예측 에이전트가 "N개월 회복"이라고 할 때, 일간 변동성이 5%를 넘으면 예측을 3분의 1에서 5분의 1로 줄여라.
