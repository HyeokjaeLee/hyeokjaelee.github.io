...
다음 내용은 summary에 자주 사용하는 영어 단어 목록입니다.
<br>한국 개발자 분이 [해당 포스트](https://blog.ull.im/engineering/2019/03/10/logs-on-git.html)에 잘 정리해 주신 글이 있습니다.
<br>해당 원문을 참고하시는걸 추천 드립니다.
