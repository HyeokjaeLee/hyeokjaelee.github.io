...
두 번째는 폰트 굵기, 줄 높이, 자간, 패딩, 마진, 간격, 색상까지 전부.
...
디렉토리 목록은 약 99% 절감, git 상태는 약 64% 절감, grep은 약 44% 절감.

디렉토리 목록이 극단적인 건 출력이 구조적으로 길기 때문이다.
