...
기획 내용이랑 디자인 의도가 둘 다 들어가야 개발자가 그 노트만 보고 구현할 수 있다.
...
문서 분석에 디자인 분석까지 다 맡기니까 컨텍스트가 무거워지고 품질도 떨어졌다.
...
분석도 메인 에이전트가 다 하는 구조에서 전문 에이전트가 나눠서 하는 구조로 바꿨다.
...
메인 에이전트가 다 하면 편할 것 같지만 실제로는 컨텍스트가 무거워지고 품질이 떨어진다.
