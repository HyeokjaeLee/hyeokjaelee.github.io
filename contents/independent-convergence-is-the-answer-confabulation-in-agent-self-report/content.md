...
description: '9개 오픈소스 프로젝트의 버그를 독립된 세션에서 수정했다.

axios는 3개 세션이 독립적으로 같은 해결책에 도달했다 같은 버그를 보고 같은 수정을 내놓으면, 그게 가장 자연스러운 일반화다 그리고 에이전트가 자기 추측을 사실로 보고한 것도 발견했다.'
