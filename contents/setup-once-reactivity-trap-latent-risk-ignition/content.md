...
description: 'Vue의 setup 한 번 값이 watchEffect를 영구적으로 막아서 간헐적 버그를 만들었다
...
어떤 테스트를 열었느냐에 따라 버그가 나올 수도 안 나올 수도 있다.
